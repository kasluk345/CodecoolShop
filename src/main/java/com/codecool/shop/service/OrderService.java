...
public class OrderService {
    ...
    public void handlePutProduct(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        //data from API (generated by JavaScript as String)
        String frontData = req.getReader().readLine();
        System.out.println("LOG (OrderService-l50)| OPTION: "+frontData);
        //remove Cart from memory (productDao)
        this.cartDaoMem = null;
    }
